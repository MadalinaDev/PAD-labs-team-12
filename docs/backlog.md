...
| Next lab planning | Scaffold Battle and Tamagotchi services | Sava | NestJS projects, isolated PostgreSQL databases, validated DTOs and documented local launch |
...
| Next lab planning | Scaffold Guild and Notification services | Vica | NestJS projects; guild membership/chat contracts and Firebase delivery setup ready |
...
| Next lab planning | Scaffold User Management and Map services | Mădălina | Spring Boot projects; isolated PostgreSQL/PostGIS databases; auth and location DTOs |
...
| Next lab planning | Scaffold Monster Raid and Package Registry services | Sabina | Spring Boot projects, immutable definition schemas and scheduler persistence |
